...
function Logo({ fill = "#ffff", className = "" }: Props) {
	return (
		<svg version="1.1" xmlns="http://www.w3.org/2000/svg" className={className} xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 250.1 200" xmlSpace="preserve">
			<g transform="matrix(2.25,0,0,2.25,-2.25,-9.0087890625)">
				<g transform="translate(0,-1020.3622)">
					<path
						style={{ fill }}
						d="M45.2,1024.4c-10,0-18,7.9-18.6,17.9c-2,0.5-3.9,1.3-5.6,2.4c-5.1,3-8.7,9.4-8.8,16.2
